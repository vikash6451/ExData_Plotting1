...
par(mfrow=c(2,2))
plot(myData$date_time,myData$Global_active_power,main="",ylab="Global Active Power(Kilowatts)",xlab="",type="l")
plot(myData$date_time,myData$Voltage,ylab="Voltage",xlab="datetime",main="",type="l")
...
plot(myData$date_time,myData$Global_reactive_power,main="",xlab="datetime",ylab="Global_reactive_power",type="l")